...
<html lang="en">
  ...
  <body>
  <div class="topnav">
      <a class="active" href="table.php"><img src="./image/Starcorps logo/logofix.png"></a>   
      <div class="search">
        <div class="dropbtn">
      ...
      <div class="dropdown">
        ...
        <div class="dropdown-content">
          ...
          <a href="https://twitter.com/zian__z?t=ZBnouTC5k9HndHtXIAeaPQ&s=09"
            >Twitter</a
          >
          <a href="https://web.facebook.com/adityazianurrahman/">Facebook</a>
          <a href="mailto:adityazianurrahman@gmail.com" title="E-mail"
            >E-mail</a
          >
        </div>
      </div>
        ...
        <div class="table-responsive">
          <table id="myTable" class="table table-striped custom-table">
            ...
            <?php foreach ($data_pegawai as $dp) : ?>
              <tr scope="row">
                ...
                <td>
                  <?= $dp["Jabatan"]; ?>
                  <small class="d-block"
                    >Far far away, behind the word mountains</small
                  >
                </td>
                <td>
                  <a href='detail.php?id=<?php echo $dp["ID"]; ?>' class="more"
                    >Details</a
                  >
                </td>
                <td>
            ...
            <td colspan="11" align="center">
              <a href="tambah.php" class="more" ><span class="text">ADD</span></a></td>
        </tr>   
            </tbody>
